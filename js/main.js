...
const showMenu = (toggleId, navId) => {
  ...
  if (toggle && nav) {
    toggle.addEventListener("click", () => {
      // menambahkan class show-menu ke tag div dengan class nav__menu
...
function linkAction() {
  ...
  // Ketika mengklik navlink, menyembunyikan show-menu class
...
// Theme yang dipilih sebelumnya (jika user klik)
...
// validasi jika pengguna sebelumnya
if (selectedTheme) {
